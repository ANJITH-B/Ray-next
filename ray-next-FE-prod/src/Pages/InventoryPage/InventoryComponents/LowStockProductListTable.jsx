...
import { useGetLowStock, useDeleteInventory } from "../../../Queries/InventoryQuery/InventoryQuery";
...
const LowStockProductListTable = ({ tabIndex }) => {
  const [filter, setFilter] = useState({
    pageNo: 1,
    pageCount: 10,
  });
  const { data: inventory, isLoading } = useGetLowStock(filter);
...
export default LowStockProductListTable;
