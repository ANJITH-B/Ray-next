...
import { useGetBill, useGetPurchaseOrder, useGetPurchaseReturn } from "../../../../Queries/PurchaseQuery/PurchaseQuery";
  ...
  return (
    <div className="p-8 max-w-[1512px]   h-auto m-auto">
      <div className="flex items-center justify-between w-full mb-12">
        <div>
          <h1 className="text-2xl 2xl:text-3xl  font-semibold">Purchase History</h1>
        </div>
