...
import SuppliarCard from "../../../../CommonComponents/OtherComponent/SupplairCard";
import { useAddPurchaseReturn } from "../../../../Queries/PurchaseQuery/PurchaseQuery";
import ReturnTable from "./ReturnTable";
import { Tooltip } from "antd";
const purchaseReturnValidation = () => {
  return Yup.object().shape({
    payment_type: Yup.string().required("Payment type is required"),
    supplier_id: Yup.string().required("Please select supplier"),
    purchase_return_items: Yup.array()
...
const PurchaseReturnPage = () => {
  ...
  const initialValues = useCallback(
    {
      purchase_return_id: id?.data?.data?.return_id,
  ...
  const formik = useFormik({
    ...
    validationSchema: purchaseReturnValidation,
  });
  const addItem = () => {
    const data = {
      purchase_bill_id: formik.values.purchase_bill_id,
      issuing_date: formik.values.issuing_date,
      supplier_id: formik.values.supplier_id,
  ...
  const totalAmount = formik?.values?.purchase_return_items
    ?.map((e) => e.net_amount)
    .filter((e) => e !== undefined)
    .reduce((a, b) => a + b, 0);

  const { mutateAsync: addInvoice, isLoading } = useAddPurchaseReturn();
  const handleSubmit = () => {
    const data = {
      purchase_return_id: formik.values.purchase_return_id,
      issuing_date: formik.values.issuing_date,
      supplier_id: formik.values.supplier_id,
      ...
      summary: {
        ...
        additional_details: "String",
        net_amount: formik.values?.purchase_return_items
          .map((e) => {
            return e.net_amount;
          })
          ?.reduce((e, i) => {
      ...
      purchase_return_items: formik.values.purchase_return_items,
    };
    addInvoice(data)
      .then((res) => {
        if (res.status === 500) {
      ...
      <div className="p-8  max-w-[1512px]   h-auto m-auto">
        <div>
          ...
          <div className="flex gap-12 mb-12">
            ...
            <div className="flex-1">
              <DetialsContainer color={"bg-purchase-color"}>
        ...
        <div className="mb-12">
          <div className="mb-6 flex w-full items-center justify-between">
            ...
            >
              {formik.errors.purchase_return_items ? (
                <div
                  className={`${
                    formik.errors.purchase_return_items
                ...
                >
                  <Tooltip
                    trigger={"hover"}
                    title={formik.errors.purchase_return_items}
                    color="white"
        ...
        <div>
          <div className="mb-6">
            <p className="text-xl 2xl:text-[24px] font-semibold">
              Other Detials
            </p>
          </div>
          <div className="flex items-center gap-6">
            ...
            <div className="flex-[.5]">
              ...
              <div className="  focus-within:border-blue transition-all border-[1px] border-border-gray rounded-xl">
                <button
        ...
        <div className="flex items-center   max-w-[1512px]   h-full m-auto">
          ...
          <div className="flex-[1] flex justify-between">
            <div className="flex flex-[.6] flex-col gap-1">
              ...
              <div className="text-gray text-sm 2xl:text-base">
                Savings applied
              </div>
            </div>
            <div className="flex flex-[.6] flex-col gap-1">
            ...
            <div className="flex flex-[.8]  items-center gap-6">
              ...
              >
                <p className="whitespace-nowrap 2xl:text-base text-sm">
                  Additional details
                </p>{" "}
              </button>
              <button
