...
import AddSupplierModal from "../../../../CommonComponents/OtherComponent/AddSupplierModal";
const Filter = ({ setFilter, tabIndex }) => {
  ...
  return (
    <Dropdown
      dropdownRender={() => {
        return (
          <div className="bg-white w-[150%] p-8 shadow-lg">
  ...
  return (
    <div className="p-8 max-w-[1512px]   h-auto m-auto">
      <div className="flex items-center justify-between w-full mb-12">
        <div>
          <h1 className="text-2xl 2xl:text-3xl font-semibold mb-2 2xl:mb-4">Suppliers</h1>
          <p className="text-gray 2xl:text-base text-sm">Manage and monitor supplier list</p>
        </div>
