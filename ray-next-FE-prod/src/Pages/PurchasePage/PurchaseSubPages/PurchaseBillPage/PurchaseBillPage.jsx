...
import Billable from "./BillTable";
import SuppliarCard from "../../../../CommonComponents/OtherComponent/SupplairCard";
import { useAddBill } from "../../../../Queries/PurchaseQuery/PurchaseQuery";
...
const PurchaseBillPage = () => {
  ...
  const initialValues = useCallback(
    {
      purchase_bill_id: id?.data?.data?.Bill_id,
  ...
  const totalAmount = formik?.values?.purchase_items
    ?.map((e) => e.net_amount)
    .filter((e) => e !== undefined)
    .reduce((a, b) => a + b, 0);

  const { mutateAsync: addInvoice, isLoading } = useAddBill();
  ...
  const handleSubmit = () => {
    const data = {
      ...
      net_amount: formik.values?.purchase_items
        .map((e) => {
          return e.net_amount;
        })
        ?.reduce((e, i) => {
      ...
      summary: "String",
      purchase_items: formik.values.purchase_items,
    };
    addInvoice(data)
      .then((res) => {
        if (res.status === 500) {
      ...
      <div className="p-8  max-w-[1512px]   h-auto m-auto">
        <div>
          ...
          <div className="flex gap-6 2xl:gap-8 mb-8">
            ...
            <div className=" flex-[.6]">
              <SuppliarCard clear={clear} formik={formik} />
            </div>
                  ...
                  <div className=" flex gap-4 2xl:gap-12">
                    ...
                    <div className="flex flex-col h-full justify-between gap-1">
                      <div className="flex items-center gap-1">
                        ...
                        <div className="max-w-[5rem] ml-2 mt-2 mb-1">
                          <BorderLessInput
                            onInput={onlyNumbers}
                            placeholder="Enter"
                            onChange={formik.handleChange}
            ...
            >
              {formik.errors.purchase_items ? (
                ...
                >
                  <Tooltip
                    trigger={"hover"}
                    title={formik.errors.purchase_items}
                    color="white"
            ...
            <div className="flex-[.5]">
              ...
              <div className="border-[1px]  focus-within:border-blue transition-all border-border-gray rounded-xl">
                <button
                  ...
                  className="flex items-center justify-between w-full px-3 py-[10px]  "
                >
