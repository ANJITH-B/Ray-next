...
import shoe from "../../../../Assets/CommonImages/shoe.jpg";
...
const LPOTable = ({ formik, edit, setEdit, item, setItem }) => {
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (
                      ...
                      if (
                        formik.values.purchase_order_items?.filter(
                          (e) => e.index === index
                        ).length > 0
                      ) {
                        formik.setFieldValue("purchase_order_items", [
                          ...formik.values.purchase_order_items?.filter(
                            (e) => e.index !== index
                          ),
                          {
                        ...
                        formik.setFieldValue("purchase_order_items", [
                          ...formik.values.purchase_order_items,
                          {
                            index: index,
                            item_code: record["item_code"],
                            description: record["Item description"],
