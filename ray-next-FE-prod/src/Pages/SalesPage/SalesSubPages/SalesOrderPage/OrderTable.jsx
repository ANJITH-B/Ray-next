...
const OrderTable = ({ formik, edit, setEdit, item, setItem }) => {
            ...
            {edit === index ? (
              <div className="min-w-full">
                <BorderdInput
                  ...
                  defaultValue={select?.description || record["Item description"]}
                  error={
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (
                      ...
                      if (
                        formik.values.sales_order_items?.filter(
                          (e) => e.index === index
                        ).length > 0
                      ) {
                        formik.setFieldValue("sales_order_items", [
                          ...formik.values.sales_order_items?.filter(
                            (e) => e.index !== index
                          ),
                          {
                        ...
                        formik.setFieldValue("sales_order_items", [
                          ...formik.values.sales_order_items,
                          {
                            index: index,
                            item_code: record["item_code"],
                            description: record["Item description"],
