...
import { useAddQuatation } from "../../../../Queries/SalesQuery/SalesQuery";
...
const quotationValidation = () => {
  return Yup.object().shape({
    ...
    sales_quotation_items: Yup.array()
...
const SalesQuatationPage = () => {
  ...
  const { data: id,refetch } = useGetID({ section: "sales", module: "quotation" });

  const initialValues = useCallback(
    {
      sales_quotation_id: id?.data?.data?.quot_id,
  ...
  const totalAmount = formik?.values?.sales_quotation_items
    ?.map((e) => e.net_amount)
    .filter((e) => e !== undefined)
    .reduce((a, b) => a + b, 0);

  const { mutateAsync: addInvoice, isLoading } = useAddQuatation();
  const handleSubmit = () => {
    const data = {
      sales_quotation_id: formik.values.sales_quotation_id,
      ...
      summary: {
        ...
        net_amount: formik.values?.sales_quotation_items
        .map((e) => {
          return e.net_amount;
        })
        ?.reduce((e, i) => {
      ...
      sales_quotation_items: formik.values.sales_quotation_items,
    };
  ...
  return (
    <div className="">
      <div className="p-8  max-w-[1512px]   h-auto m-auto">
        <div>
          <AllHeadSection
            id={id?.data?.data?.quot_id}
            formik={formik}
            head={"Sales Quotation"}
            name={"invoice_id"}
          />
              ...
              <DetialsContainer color={"bg-overdue-color"}>
                <div className="w-full">
                  <div className="w-full flex items-center justify-between gap-2 mb-2">
                    <h2 className=" text-base 2xl:text-lg font-semibold"> Sales quotation details</h2>
                    <img src={wise} alt="" />
                  </div>
                  ...
                  <div className="flex gap-12">
                    <div className="flex flex-col h-full justify-between ">
                      ...
                      <div className="flex items-center gap-1">
                        <p className="text-sm 2xl:text-base whitespace-nowrap">Return notes:</p>
        ...
        <div className="mb-12">
          <div className="mb-6 flex w-full items-center justify-between">
            ...
            >
              {formik.errors.sales_quotation_items ? (
                <div
                  className={`${
                    formik.errors.sales_quotation_items
                ...
                >
                  <Tooltip
                    trigger={"hover"}
                    title={formik.errors.sales_quotation_items}
                    color="white"
        ...
        <div className="flex items-center   max-w-[1512px]   h-full m-auto">
          ...
          <div className="flex-[1] flex justify-between">
            ...
            <div className="flex flex-[.6] flex-col gap-1">
              ...
              <div>
                <p className="font-semibold">00.0</p>
              </div>
              <div className="text-gray text-sm 2xl:text-base">savings applied</div>
            </div>
            ...
            <div className="flex flex-[.8]  items-center gap-6">
              ...
              >
                {isLoading ? (
                  ...
                  <p className="whitespace-nowrap 2xl:text-base text-sm text-white">Save & close</p>
                )}
              </button>
            </div>
          </div>
...
export default SalesQuatationPage;
