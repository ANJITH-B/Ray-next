...
const QuatationTable = ({ formik, edit, setEdit, item, setItem }) => {
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (
                      ...
                      if (
                        formik.values.sales_quotation_items?.filter(
                          (e) => e.index === index
                        ).length > 0
                      ) {
                        formik.setFieldValue("sales_quotation_items", [
                          ...formik.values.sales_quotation_items?.filter(
                            (e) => e.index !== index
                          ),
                          {
                        ...
                        formik.setFieldValue("sales_quotation_items", [
                          ...formik.values.sales_quotation_items,
                          {
                            index: index,
                            item_code: record["item_code"],
                            description: record["Item description"],
