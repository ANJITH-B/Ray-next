...
import BorderdSelectRounded from "../../../../CommonComponents/FormInputs/BorderdSelectRounded";
import {
  useGetAccountBook,
...
const AccountBookPage = () => {
  ...
  useEffect(() => {
    if (isSuccess) {
      setFilter((pre) => ({
        ...pre,
        account: data?.data?.data?.find((e) => {
          return e.account_name === "Sales account";
        })?._id,
      }));
    }
  }, [isSuccess]);
      ...
      <div className="flex items-center justify-between w-full mb-4">
        <div>
          ...
          <p className="text-gray 2xl:text-base text-sm">
            Manage and monitor account book list
          </p>
        </div>
